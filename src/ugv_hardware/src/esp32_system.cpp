#include "ugv_hardware/esp32_system.hpp"
...
CallbackReturn ESP32System::on_init(const hardware_interface::HardwareComponentInterfaceParams & params)
{
  ...
  // PARAMETERS: URDF <ros2_control><hardware><param> (ugv_description/urdf/ros2_control.xacro)
...
PLUGINLIB_EXPORT_CLASS(ugv_hardware::ESP32System, hardware_interface::SystemInterface)
